...
O sistema implementado permite simular dados realistas de consumo energético, aplicar engenharia de características temporais, treinar diferentes modelos preditivos e comparar o seu desempenho através de métricas quantitativas e análise gráfica.
...
- Baselines simples de referência
- Modelos de regressão linear regularizada
- Modelos de ensemble (Random Forest e Gradient Boosting)
- Modelos estatísticos de séries temporais (SARIMAX)
